...
def detail_url(recipe_id):
    """Create url from given recipe_id"""
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_other_users_recipe_error(self):
        """Test other users cant delete another users recipe"""
        new_user = create_user(email='user2@example.com', password='test123')
    ...
    def test_create_recipe_with_existing_tags(self):
        """Test creating a recipe with old tags"""
    ...
    def test_create_recipe_with_existing_ingredients(self):
        """Test create recipe with existing """
        ingredient_italian = Ingredient.objects.create(
            user=self.user,
            name='Dough'
            )
        payload = {
        ...
        recipe = recipes[0]
        self.assertEqual(recipe.ingredients.count(), 2)
        self.assertIn(ingredient_italian, recipe.ingredients.all())
        for ingredient in payload['ingredients']:
            exists = recipe.ingredients.filter(
                name=ingredient['name'],
                user=self.user,
    ...
    def test_create_ingredient_on_update(self):
        """Test add ingredient on update recipe"""
        recipe = create_recipe(user=self.user)
...
class IageUploadTests(TestCase):
